  ...
  <div id="app">
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui text container">
        ...
        <h2 class="ui inverted header">Caio Canoas
          <div class="sub header">Desenvolvedor Java/JavaScript/Python</div>
        </h2>
        <h3 class="ui inverted header">São Paulo, Brasil - 2020</h3>
        <a class="tiny ui linkedin button" type="button" href="https://www.linkedin.com/in/caio-canoas-31427a56/">
          <i class="linkedin icon"></i>
          LinkedIn
        </a>
        <a class="tiny ui twitter button" type="button" href="https://twitter.com/Caioti">
